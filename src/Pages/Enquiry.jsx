...
const Enquiry = () => {
    ...
    const SubmitHandle = async (event) => {
        ...
        try {
            ...
            if (lName === '') {
                ...
                await response.json()
                SetData({ ...Data, fName: '', lName: '', Email: '', Number: '', State: '', Segment: '' })
    ...
    return (
        <>
            <div className='flex justify-center py-5 bg-[#224072] bg-opacity-10'>
            ...
            <div className='lg:h-[22rem] bg-[#224072] bg-opacity-10 flex justify-center items-center flex-col mb:h-auto mb:py-5 lg:py-0'>
                ...
                <form onSubmit={SubmitHandle}
                    ...
                    {/* 1st form div  */}
                    <div className='flex lg:space-x-14 lg:flex-row mb:flex mb:flex-col mb:items-center mb:justify-center mb:space-y-7 mb:space-x-0 lg:space-y-0'>
                        ...
                        <input type="text" className='font-Poppins rounded-3xl py-3 px-6 text-lg w-80 border-[0.6px] outline-none border-[#224072]' name="lName" value={Data.lName} onChange={handleInput} required id="" placeholder='Last Name' />
                    ...
                    {/* 2nd form div  */}
                    <div className='flex lg:space-x-14 mb:flex mb:flex-col mb:space-x-0 mb:space-y-7 lg:flex-row lg:space-y-0'>
                ...
                <div className='flex justify-center items-center'>
                    <button type='submit' onSubmit={SubmitHandle} onClick={SubmitHandle} className='py-2 px-10 bg-[#224072] font-[500] rounded-3xl font-Poppins text-white text-xl'>Submit</button>
